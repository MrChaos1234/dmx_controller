...
class FixtureQmlPresentationModel(QObject):
    ...
    def __init__(self, fixture_id: str, fixture_name: str, fixture_library_id: str, fixture_display_name:str, channel_mode: str, dmx_start_address: str, selected: bool, parent: QObject = None):
        ...
        # print("Fixture Model: " + str(self._id) + " " + str(self._fixture_name) + " " + str(self._fixture_library_id) + " " + str(self._fixture_display_name) + " " + str(self._channel_mode) + " " + str(self._dmx_start_address) + "\n")
